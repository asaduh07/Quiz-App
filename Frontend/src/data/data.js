export const data={
  uniqueTags: [
    "JavaScript", "React", "Angular", "Vue.js", "Svelte", "Frontend", "Backend",
    "API", "Testing", "Postman", "Insomnia", "SoapUI", "REST Assured",
    "Node.js", "Express", "Koa", "NestJS", "MongoDB", "SQL", "Database",
    "NoSQL", "GraphQL", "REST", "CI/CD", "Jenkins", "Travis CI", "CircleCI",
    "GitHub Actions", "DevOps", "Automation", "Webpack", "Parcel", "Rollup",
    "Gulp", "Build Tools", "Docker", "Kubernetes", "Containerization",
    "Cloud", "AWS", "Azure", "Google Cloud", "DigitalOcean", "Heroku",
    "Vercel", "Netlify", "Security", "Encryption", "Authentication",
    "Authorization", "OAuth", "JWT", "API Keys", "HMAC", "Web Performance",
    "LCP", "FID", "CLS", "TTFB", "Optimization", "SEO", "User Experience",
    "CSS", "SASS", "LESS", "Styled Components", "Emotion", "JSS",
    "TypeScript", "Python", "Flask", "Django", "FastAPI", "ORM", "SQLAlchemy",
    "Pandas", "Numpy", "Machine Learning", "TensorFlow", "PyTorch",
    "scikit-learn", "Keras", "Data Science", "Neural Networks", "AI",
    "Functional Programming", "OOP", "Procedural Programming", "Declarative Programming",
    "Software Engineering", "Design Patterns", "MVC", "MVVM", "Microservices",
    "Serverless", "PWA", "JAMstack", "GraphQL", "REST", "HTTP"
  ],
  questions: [
    {
    ...
    },
    {
      ...
      "correct": ["Git", "SVN"],
      "type": "multiple",
      "tags": ["Version Control", "Git", "SVN", "Mercurial", "CVS", "DevOps", "Development", "Code Management", "Collaboration", "Tools"]
    },
    {
      ...
      "correct": ["SQL"],
      "type": "single",
      "tags": ["Database", "Query Language", "SQL", "GraphQL", "DQL", "JQL", "Backend", "Data Management", "Web Development", "Programming"]
    },
    {
      "question": "Which of the following are programming languages used for mobile app development?",
      "options": ["Swift", "Kotlin", "JavaScript", "Objective-C"],
      "correct": ["Swift", "Kotlin"],
      "type": "multiple",
      "tags": ["Programming", "Languages", "Mobile Development", "Swift", "Kotlin", "JavaScript", "Objective-C", "iOS", "Android", "Development"]
    },
    {
      ...
      "correct": ["Django"],
      "type": "single",
      "tags": ["Python", "Web Framework", "Django", "Flask", "FastAPI", "Pyramid", "Backend", "Web Development", "Frameworks", "Development"]
    },
    {
      "question": "Which of the following are authentication methods for web applications?",
      "options": ["OAuth", "JWT", "Basic Auth", "SAML"],
      "correct": ["OAuth", "JWT"],
      "type": "multiple",
      "tags": ["Web Security", "Authentication", "OAuth", "JWT", "Basic Auth", "SAML", "Web Development", "Protocols", "Security", "Backend"]
    },
    {
      ...
      "correct": ["Node.js"],
      "type": "single",
      "tags": ["JavaScript", "Runtime Environment", "Node.js", "Deno", "Bun", "Nashorn", "Backend", "Web Development", "Server-side", "Development"]
    },
    {
      ...
      "type": "multiple",
      "tags": ["Testing", "Types", "Unit Testing", "Integration Testing", "System Testing", "Acceptance Testing", "QA", "Development", "Software Engineering", "Best Practices"]
    },
    {
      "question": "Which of the following is a NoSQL database?",
      "options": ["MongoDB", "Firebase", "Cassandra", "DynamoDB"],
    ...
    },
    {
      ...
      "correct": ["Bootstrap"],
      "type": "single",
      "tags": ["CSS", "Framework", "Bootstrap", "Tailwind CSS", "Bulma", "Foundation", "Frontend", "Web Development", "Styling", "Design"]
    },
    {
      "question": "Which of the following are methods for optimizing website performance?",
      "options": ["Caching", "Compression", "Minification", "Lazy Loading"],
    ...
    {
      "question": "Which of the following are popular frontend libraries for data visualization?",
      "options": ["D3.js", "Chart.js", "Highcharts", "Three.js"],
      "correct": ["D3.js", "Chart.js"],
      "type": "multiple",
      "tags": ["Data Visualization", "JavaScript", "Frontend", "D3.js", "Chart.js", "Highcharts", "Three.js", "Web Development", "Libraries", "UI"]
    },
    {
      "question": "Which of the following are types of machine learning?",
      "options": ["Supervised", "Unsupervised", "Reinforcement", "Transfer"],
    ...
    },
    {
      ...
      "correct": ["Kubernetes"],
      "type": "single",
      "tags": ["Containerization", "Tools", "Kubernetes", "Docker", "Podman", "LXC", "DevOps", "Cloud", "Infrastructure", "Deployment"]
    },
    {
      "question": "Which of the following are JavaScript libraries for state management?",
      "options": ["Redux", "MobX", "Recoil", "Vuex"],
      "correct": ["Redux", "MobX"],
      "type": "multiple",
      "tags": ["JavaScript", "State Management", "Redux", "MobX", "Recoil", "Vuex", "Frontend", "Web Development", "Libraries", "UI"]
    ...
    },
    {
      ...
      "correct": ["Django"],
      "type": "single",
      "tags": ["Python", "Backend", "Django", "Flask", "FastAPI", "Pyramid", "Web Development", "Frameworks", "Development", "Server-side"]
    },
    {
      ...
      "type": "multiple",
      "tags": ["JavaScript", "Testing", "Jest", "Mocha", "Chai", "Cypress", "Frontend", "Web Development", "Libraries", "QA"]
    },
    {
      "question": "Which of the following are types of software testing?",
      "options": ["Unit Testing", "Integration Testing", "System Testing", "Acceptance Testing"],
    ...
    {
      "question": "Which of the following is a JavaScript framework for server-side rendering?",
      "options": ["Next.js", "Nuxt.js", "Angular", "Svelte"],
      "correct": ["Next.js"],
      "type": "single",
      "tags": ["JavaScript", "Server-side Rendering", "Next.js", "Nuxt.js", "Angular", "Svelte", "Frontend", "Web Development", "Frameworks", "SSR"]
    },
    {
      "question": "Which of the following are methods for optimizing website performance?",
      "options": ["Caching", "Compression", "Minification", "Lazy Loading"],
